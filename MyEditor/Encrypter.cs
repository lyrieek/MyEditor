...
namespace MyEditor
{
    ...
    class Encrypter
    {
        ...
        /// DES解密
        /// </summary>
        /// <param name="output">加密后字符串</param>
        /// <param name="sKey">密钥</param>
        /// <returns>解密字符串</returns>
        public static string DecryptString(string output, string sKey)
        {
            string[] sInput = output.Split("-".ToCharArray());
        ...
        /// Md5加密
        /// </summary>
        /// <param name="pToEncrypt">输入字符</param>
        /// <param name="sKey">密钥</param>
        ...
        /// Md5解密
        /// </summary>
        /// <param name="pToDecrypt">加密后字符串</param>
        /// <param name="sKey">密钥</param>
        /// <returns>解密字符串</returns>
